...
# MAGIC %md
# MAGIC ## Use off-the-shelf Stable Diffusion XL Base 

# COMMAND ----------

# MAGIC %md
# MAGIC Stable Diffusion XL Base is one of the most powerful open-source text-to-image models available today (as of March 1, 2024) for commercial usage. The model was developed by Stability AI, and its weights are publicly accessible via Hugging Face, which has native support on Databricks. To download this model from Hugging Face and make an inference, run the following cells. 
